...
class box_crud extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if(isset($MainM_ID)){
            ...
            $box=box::where ($page_id,$MainM_ID)->orderBy('id')->get();
...
box::whereRaw("ID = (select Min(id) from boxes Where cat_type='$cat' And  $page_id='$MainM_ID')")->update([    
    ...
    public function update(Request $request,box $boxitem)
    {
        ...
        if(isset($_POST['upcat'])){
           ...
           box::where($page_id, $MainM_ID)-> where('cat_type', $cat_typeprev)->update([    
...
box::whereRaw("ID = (select Min(id) from boxes Where cat_Name='$cat_typeprev' And   $page_id='$MainM_ID')")->update([    
