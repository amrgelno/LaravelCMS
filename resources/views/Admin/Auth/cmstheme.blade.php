<div class="wrapper">
    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
        ...
        <div class='col-md-4'>
            ...
            <img src="{{ asset('Front/ICON/IframeLogo.svg') }}" class='col-md-6 d-xs-none' alt="IframeCMS"
                title="IframeCMS">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <span class="brand-text font-weight-light">AdminLTE 3</span>
        ...
        <div class="sidebar">
            ...
            <img src="{{ asset('Front/ICON/IframeLogo.svg') }}" class='col-xs-12 d-lg-none d-md-none' alt="IframeCMS"
                title="IframeCMS">
            ...
            <nav class="mt-2">
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <li class="nav-item">
                                <a href="#Customize" class="nav-link">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p class="hint--right" aria-label="أدارة الثيمات والميزات "> Customize Theme &
                                        features </p>
                                </a>
                            </li>
                    ...
                    @if (auth::guard('admin')->user()->User_Role == 'Admin')
                        <li class="nav-item menu-open">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="{{ route('Admin.register') }}" target='_blank' rel='noopener noreferrer'
                                        class="nav-link" onclick="performCalc()">
                                        <i class="far fa-circle nav-icon"></i>
                    ...
                    <li class="nav-item">
                        <a href="{{ route('Admin.LogOut') }}" class="nav-link" class="hint--right"
    ...
    <div id='clientcomment'> @yield('clientcomment') << /div>
            ...
            <footer class="main-footer">
                ...
                <!-- Default to the left -->
                <strong>Copyright &copy; 2014-2021 <a href="https://adminlte.io">Tiktuk</a>.</strong> All rights
                reserved.
            </footer>
    </div>
    <!-- ./wrapper -->
