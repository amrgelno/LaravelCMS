...
<body bgcolor="darkkhaki" onload="loader()">
    ...
    <div class="logo" align="center"><img src="http://{{ $Domain_site }}/Front/ICON/viewweb.png"
            class="loading-logo" />
        <h1> Build your Page With Customize page Web Tool </h1>
        <br />
        من خلال أداة بناء محتوى يمكنك تصميم محتوى فريدة و تحريره وبناء قالبك مع أداوت تخصيص الصفحة
        <br />
        <div class='preloader' align="center"><img src="http://{{ $Domain_site }}/Front/ICON/wpspin-2x.gif"
                class="loading-logo" align="center" /> </div>
        <hr />
    </div>
    ...
    <div class="watch-video"><button id="Paragraph-bt" STYLE="background:#000;" />
        <a href="http://{{ $Domain_site }}/Front/CMS_VIDEO/insparag.mp4" target="_blank" style="color:#FFF;">HOW TO
            USE</a></button>
    </div>
    ...
    <div class="watch-video"><button id="Article&topic-bt" STYLE="background:#000;" />
        <a href="http://{{ $Domain_site }}/Front/CMS_VIDEO/instopic.mp4" target="_blank" style="color:#FFF;">HOW TO
            USE</a></button>
    </div>
    <h1 class="Article-bt hint--right" onclick='Articlebt();' aria-label="المقالأت و الموضوعات"> Article&topic </h1>
    <!--<div class="topicopen-buttor"> >> </div> <div class="topicClose-buttor"> << </div>-->
    <div class="Article">
    ...
    <div class="watch-video"><button id="Boxes&categeory-bt" STYLE="background:#000;" />
        <a href="http://{{ $Domain_site }}/Front/CMS_VIDEO/categories.mp4" target="_blank" style="color:#FFF;"> HOW
            TO USE</a></button>
    </div>
    ...
    <div class="Boxes">
        <form name="BOXScript">
            <input type="text" name="cat_Name" placeholder="Add categeories,Excursions,Cards_Name" size="40"
                id="boxcat" required />
            <input type="number" name="count" id="boxcounter" placehoder="insert number image"
    ...
    <script>
        function addval() {
            ...
            var F =
                "<br/><br/><form action='{{ route('box.store') }}' name='form' method='post' enctype='multipart/form-data' style='display:flex;flex-wrap: wrap;flex-direction: column;align-items: baseline;align-content: flex-start;justify-content: center;'>";
            var csrf = '@csrf';
            var m = "<input type='text' name='boxtitle[]' placeholder='boxshow caption'/><br>";
            var y = "<input type='file'  name='boxshow[]'  value='search for a file' /><br>";
            var N =
                "<textarea type='text' name='boxDesc[]'   placeholder='box_Description'/>box_Description </textarea><hr/>";
    ...
    @if (isset($box_ID))
        @if ($BusinessModel == 'E-commerce')
            <img src="http://{{ $Domain_site }}/Front/ICON/dribbble-categories.png" class="Boxes-img" />
            <div class="watch-video"><button id="Boxes&categeory-bt" STYLE="background:#000;" />
                <a href="http://{{ $Domain_site }}/Front/CMS_VIDEO/categories.mp4" target="_blank"
                    style="color:#FFF;"> HOW TO USE</a></button>
            </div>
            ...
            <script>
                function addprod() {
                    ...
                    var F =
                        "<form action='{{ route('product.store') }}' name='form'  method='post' enctype='multipart/form-data'>";
                    var csrf = '@csrf';
                    ...
                    var X =
                        "<textarea type='text' name='proddisc[]'   placeholder='product_Description'/>product_Description </textarea><hr/>";
                    ...
                    for (i = 1; i <= x; i++) {
                        document.write(+i + '    ' + F + csrf + ' ' + m + ' ' + N + '  ' + s + ' ' + K + '  ' + z + '    ' + f +
                            ' ' + w + ' ' + e + '' + p + '' + l + ' ' + X);
                        document.write('<br />');
                        document.write('<br />');
                        document.write('<br />');
    ...
    <div class="watch-video"><button id="slideshow-bt" STYLE="background:#000;" />
        <a href="http://{{ $Domain_site }}/Front/CMS_VIDEO/slideshow.mp4" target="_blank" style="color:#FFF;"> HOW
            TO USE</a></button>
    </div>
    <h1 class="slideshow-bt hint--right" onclick='slideshowbt();' aria-label="السليدر"> slideshow </h1>
    <!--<div class="slideshowOpen-buttor"> >> </div> <div class="slideshowclose-buttor"> << </div>-->
    <div class="slideshow">
    ...
    <script>
        function Addstatic() {
            ...
            var csrf = '@csrf';
            var Fl =
                "<form action='{{ route('SNumbers.store') }}' name='form' method='post' enctype='multipart/form-data'>";
    ...
    <img src="http://{{ $Domain_site }}/Front/ICON/banner_carrousel_slider_images_ad_promotion-512.png"
        class="cover-img" />
    ...
    <h1 class="socialmedia-bt hint--right" onclick='smediabt();' aria-label="السوشيل ميديا"> social media </h1>
    <!--<div class="socialmediaOpen-buttor"> >> </div> <div class="socialmediaClose-buttor"> <<  </div>-->
    ...
    <h1 class="KEYWORDS-bt hint--right" onclick='KEYWORDSbt();' aria-label="أداة السيو"> Meta Generator(SEO TOOLS)
    </h1>
    <div class="KEYWORDS">
        ...
        <form action="{{ route('keywords.store') }}" method="post">
            ...
            <input type="text" name="keywords" size="50px" placeholder="KEYWORD  كلمات المفتاحية" /><br />
            <br />
    ...
    <div class="watch-video"><button id="Article&topic-bt" STYLE="background:#000;" />
        <a href="http://{{ $Domain_site }}/Front/CMS_VIDEO/instopic.mp4" target="_blank" style="color:#FFF;">HOW
            TO USE</a></button>
    </div>
    <h1 class="Article-bt hint--right" onclick='faqsbt();' aria-label="أسئلة الشائعة"> FAQS & Accordion Panel </h1>
    <!--<div class="topicopen-buttor"> >> </div> <div class="topicClose-buttor"> << </div>-->
    ...
    <div class="faqs" style='display:none;'>
        <form action="{{ route('faq.store') }}" method="post" enctype="multipart/form-data">
            ...
            <br /><br />
            <br />
            <textarea type="text" name="content" placeholder="insert new topic here etc:- AccordionFAQSAnswer" cols="40"
                rows="10"></textarea>
            <!-- <input type="file"  name='upload'   value="search for a file" /> -->
            <br /><br />
            <br />
