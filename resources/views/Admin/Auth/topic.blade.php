    ...
    @if (isset($_GET['EDIT_TOPIC']) or isset($_GET['page']))
        ...
        <div class="card-body">
            <div class='card card-primary card-outline'>
                        ...
                        <table border="1" class="table table-responsive ">
                            ...
                            <tr>
                                ...
                                @foreach ($topic as $topicitem)
                                    ...
                                    <td> <INPUT TYPE="checkbox" name="checkbox[{{ $topicitem->id }}]"
                                            value="{{ $topicitem->id }}" required /> </td>
                ...
                <td>
                    <form action="{{ route('topic.show', $topicitem->id) }}" method="get">
                        @csrf
                        @method('GET')
                        ...
                        <input type="SUBMIT" name="SELECTTopic"
                            style="margin: 5% 33%;
    width: 22px;
...
@elseif(isset($_GET['SELECTTopic']))
    @foreach ($topicD as $topicitem)
        <form action="{{ route('topic.update', $topicitem->id) }}" method="post" enctype="multipart/form-data">
            ...
            &nbsp; &nbsp; <input type="text" class='topic-input' name="subject" placeholder="newsubject"
                value='{{ $topicitem->subject }}' />
            <br /> <br />
            <br />


            &nbsp; &nbsp;
            <textarea name='content' style="width: 434px; height: 154px;">{{ $topicitem->content }}</textarea>
            ...
            &nbsp; &nbsp; <input type="text" value="{{ $topicitem->Ar_subject }}" class='topic-input'
                name="Ar_subject" placeholder="newsubject" />
            <br /> <br />
            <br />

            &nbsp; &nbsp;
            <textarea name='Ar_content' style="width: 434px; height: 154px;"> {{ $topicitem->Ar_content }} </textarea>
            ...
            <select name='Topic_STYLE'>
                ...
                @if (isset($topicitem->Topic_style))
                    ...
                    <option value="Article">
                        @if ($topicitem->Topic_style == 'Article')
                            o Article
                        @else
                            Article
                        @endif
                    ...
                    <option value="AccordionPanel">
                        @if ($topicitem->Topic_style == 'AccordionPanel')
                            o AccordionPanel
                        @else
                            AccordionPanel
                        @endif
