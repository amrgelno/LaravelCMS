...
<script src="{{asset('Front/JS/navvue.js')}}" type="text/javascript" defer></script> 
<script src="{{asset('Front/JS/cdnvue.js')}}" type="text/javascript" ></script> 
<script src="{{asset('Front/JS/Axios.min.js')}}" type="text/javascript" ></script> 
