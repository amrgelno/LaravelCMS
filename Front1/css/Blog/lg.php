...
.menu_v {
    ...
    COLOR: white;
    background: unset;
    box-shadow: -10px 3px 20px 6px #4caf501a;
    /* float: left; */
}
...
ul.nav {
    ...
    list-style: none;
    background: unset;
    font-size:<?php echo $column['Fontsize']?>;
	font-style:<?php echo $column['Fontstyle']?>;
	font-family:<?php echo $column['FontType']?>;
    /* margin-left: 49%;
    margin-top: -90px;*/
    margin-left: 75%;
    margin-top:9px;
...
.nav>li{
    ...
    height: 45px;
       ...
       background:none;
       color:<?php echo $column['Fontcolor']?>;
       }
...
li.sub1 {
  ...
  height: 22px;
  font-size: medium;
 background:<?php echo $column['sub1color']?>;
  padding: 0px 16px 16px;
    height: 30px;
      }
...
ul#TREMENU {
    ...
    height: 90px;
    display:none;
    margin: 0px 0px 2px -116px;
    padding: unset;
    z-index:5;
    font-size:16px;
    background:<?php echo $column['sub2color']?>;
    display:none;
}
...
.footer {
    /*position: relative;*/
    /* position: absolute; */
   background:<?php echo $column['Footercolor']?>;
    /* width: 990px; */
    margin-left: -5px;
    /* left: 0; */
    margin-top: unset;
